...
-- 파일 콘텐츠 유형
create
type file_content_type as enum (
...
-- 견적 요청 상태
create
type estimation_status as enum (
'approve',    -- 승인됨
'requesting'
'reject'     -- 취소
);
...
create
type subscription_tier as enum (
'free',         -- 무료
'pro',          -- 프로
'pro_plus',     -- 프로+
'expert'        -- 전문가
...
-- 신고 대상 유형
create
type report_target_type as enum (
'post',         -- 게시글
'member'        -- 회원
);
...
-- 뉴스 카테고리
create
type news_category_type as enum (
'trade',        -- 무역
'market',       -- 시장 동향
'policy',       -- 정책/법률
'technology',   -- 기술
